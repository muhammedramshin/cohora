...
var TimelineComponent = /** @class */ (function () {
    function TimelineComponent(_cdr) {
        this._cdr = _cdr;
    ...
    Object.defineProperty(TimelineComponent.prototype, "timelineWrapperWidth", {
        set: function (value) {
    ...
    Object.defineProperty(TimelineComponent.prototype, "eventsMinDistance", {
        set: function (value) {
    ...
    Object.defineProperty(TimelineComponent.prototype, "timelineElements", {
        get: function () {
    ...
    Object.defineProperty(TimelineComponent.prototype, "dateFormat", {
        get: function () {
    ...
    Object.defineProperty(TimelineComponent.prototype, "dateFormatTop", {
        get: function () {
    ...
    Object.defineProperty(TimelineComponent.prototype, "disabled", {
        set: function (value) {
    ...
    Object.defineProperty(TimelineComponent.prototype, "showContent", {
        get: function () {
    ...
    TimelineComponent.pxToNumber = function (val) {
        return Number(val.replace('px', ''));
    };
    TimelineComponent.getElementWidth = function (element) {
    ...
    TimelineComponent.parentElement = function (element, tagName) {
    ...
    TimelineComponent.getTranslateValue = function (timeline) {
    ...
    TimelineComponent.setTransformValue = function (element, property, value) {
    ...
    TimelineComponent.dayDiff = function (first, second) {
        return Math.round(second.getTime() - first.getTime());
    };
    TimelineComponent.minLapse = function (elements) {
        if (elements && elements.length && elements.length === 1) {
            return 0;
        }
        var result = 0;
        for (var i = 1; i < elements.length; i++) {
            var distance = TimelineComponent_1.dayDiff(elements[i - 1].date, elements[i].date);
    ...
    TimelineComponent.prototype.onScrollClick = function (event, forward) {
        event.preventDefault();
        this.updateSlide(this.eventsWrapperWidth, forward);
        this._cdr.detectChanges();
    };
    TimelineComponent.prototype.onEventClick = function (event, selectedItem) {
        event.preventDefault();
        if (this._disabled) {
            return;
        }
    ...
    TimelineComponent.prototype.initTimeline = function (timeLines) {
        var eventsMinLapse = TimelineComponent_1.minLapse(timeLines);
    ...
    TimelineComponent.prototype.updateSlide = function (timelineTotWidth, forward) {
        var translateValue = TimelineComponent_1.getTranslateValue(this.eventsWrapper.nativeElement);
        if (forward) {
    ...
    TimelineComponent.prototype.updateTimelinePosition = function (element) {
        var eventStyle = window.getComputedStyle(element);
        var eventLeft = TimelineComponent_1.pxToNumber(eventStyle.getPropertyValue('left'));
        var translateValue = TimelineComponent_1.getTranslateValue(this.eventsWrapper.nativeElement);
    ...
    TimelineComponent.prototype.translateTimeline = function (value, totWidth) {
    ...
    TimelineComponent.prototype.setTimelineWidth = function (elements, width, eventsMinLapse) {
        var timeSpan = 100;
    ...
    TimelineComponent.prototype.updateFilling = function (element) {
        // change .filling-line length according to the selected event
        var eventStyle = window.getComputedStyle(element);
        var eventLeft = eventStyle.getPropertyValue('left');
        var eventWidth = eventStyle.getPropertyValue('width');
        var eventLeftNum = TimelineComponent_1.pxToNumber(eventLeft) + TimelineComponent_1.pxToNumber(eventWidth) / 2;
    ...
    TimelineComponent.prototype.initView = function () {
    ...
    TimelineComponent.prototype.setDatePosition = function (elements, min, eventsMinLapse) {
        var e_1, _a;
        var timelineEventsArray = this.timelineEvents.toArray();
        var i = 0;
        try {
            for (var elements_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](elements), elements_1_1 = elements_1.next(); !elements_1_1.done; elements_1_1 = elements_1.next()) {
                var component = elements_1_1.value;
                var distance = TimelineComponent_1.dayDiff(elements[0].date, component.date);
                ...
                var spanWidth = TimelineComponent_1.getElementWidth(span);
