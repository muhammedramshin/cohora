...
class ChartistComponent {
    ...
    renderChart() {
        ...
        return Promise.all(promises).then((values) => {
            ...
            if (!(type in chartist__WEBPACK_IMPORTED_MODULE_0__)) {
                throw new Error(`${type} is not a valid chart type`);
            }
            this.chart = ((/** @type {?} */ (chartist__WEBPACK_IMPORTED_MODULE_0__)))[type](...args);
            return this.chart;
        });
    }
    /**
...
//# sourceMappingURL=default~charts-charts-module~dashboard-dashboard-module~pages-full-pages-full-pages-module-es2015.js.map