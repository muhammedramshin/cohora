...
function (events) {
    ...
    function () {
        ...
        return console.warn.apply(console, Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__spread"])(['angular-calendar'], args));
    });
...
var CalendarDateFormatter = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__extends"])(CalendarDateFormatter, _super);
...
var CalendarWeekViewComponent = /** @class */ (function () {
    ...
    function (timeEvent, resizeEvent) {
        ...
        /** @type {?} */
        var tempEvents = Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__spread"])(this.events);
        ...
        function (lastResizeEvent, event) {
            ...
            /** @type {?} */
            var adjustedEvent = Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__assign"])({}, event, newEventDates);
    ...
    function (dayEvent, dragEvent) {
        if (this.snapDraggedEvents) {
            ...
            /** @type {?} */
            var adjustedEvent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__assign"])({}, originalEvent_1, newEventTimes);
            /** @type {?} */
     ...
     */
    function () {
        this.days = this.utils.getWeekViewHeader(Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__assign"])({ viewDate: this.viewDate, weekStartsOn: this.weekStartsOn, excluded: this.excludeDays, weekendDays: this.weekendDays }, getWeekViewPeriod(this.dateAdapter, this.viewDate, this.weekStartsOn, this.excludeDays, this.daysInWeek)));
    };
    /**
     * @protected
     * @return {?}
    ...
    function () {
        if (this.days && this.view) {
            this.beforeViewRender.emit(Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__assign"])({ header: this.days }, this.view));
        }
    };
    /**
     * @protected
     ...
     */
    function (events) {
        return this.utils.getWeekView(Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__assign"])({ events: events, viewDate: this.viewDate, weekStartsOn: this.weekStartsOn, excluded: this.excludeDays, precision: this.precision, absolutePositionedEvents: true, hourSegments: this.hourSegments, dayStart: {
    ...
    function (calendarEvent, resizeEvent) {
        ...
        var end = calendarEvent.end, eventWithoutEnd = Object(tslib__WEBPACK_IMPORTED_MODULE_5__["__rest"])(calendarEvent, ["end"]);
        /** @type {?} */
        var smallestResizes = {
...
var DroppableDirective = /** @class */ (function () {
    ...
    DroppableDirective.propDecorators = {
        ...
        dragActiveClass: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"] }],
        validateDrop: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"] }],
...
var ResizableDirective = /** @class */ (function () {
    ...
    function ResizableDirective(platformId, renderer, elm, zone) {
         ...
         */
        this.resizeStart = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
         * Called as the mouse is dragged after a resize event has begun. `$event` is a `ResizeEvent` object.
         */
        this.resizing = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
         * Called after the mouse is released after a resize event. `$event` is a `ResizeEvent` object.
         */
        this.resizeEnd = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
        /**
         * @hidden
         */
         ...
         * @hidden
         */
        this.mousemove = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.destroy$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this.resizeEdges$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
    ...
    function () {
        var _this = this;
        /** @type {?} */
        var mousedown$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(this.pointerEventListeners.pointerDown, this.mousedown);
        /** @type {?} */
        var mousemove$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(this.pointerEventListeners.pointerMove, this.mousemove).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_a) {
            var event = _a.event;
            if (currentResize) {
                try {
        ...
        /** @type {?} */
        var mouseup$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(this.pointerEventListeners.pointerUp, this.mouseup);
        /** @type {?} */
        var currentResize;
        /** @type {?} */
        ...
        this.resizeEdges$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(this.resizeEdges), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () {
            return (_this.resizeEdges &&
                Object.keys(_this.resizeEdges).some(function (edge) { return !!_this.resizeEdges[edge]; }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (legacyResizeEdgesEnabled) {
            return legacyResizeEdgesEnabled ? mousemove$ : rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"];
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["auditTime"])(this.mouseMoveThrottleMS), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
        ...
        var mousedrag = mousedown$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (startCoords) {
            /**
             * @param {?} moveCoords
             * @return {?}
             */
            ...
            return ((/** @type {?} */ (Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(mousemove$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (coords) { return [, coords]; })), mousemove$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["pairwise"])())))))
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(mouseup$, mousedown$)));
        }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function () { return !!currentResize; }));
        mousedrag
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (_a) {
            var clientX = _a.clientX, clientY = _a.clientY;
            return getNewBoundingRectangle((/** @type {?} */ (currentResize)).startingRect, (/** @type {?} */ (currentResize)).edges, clientX, clientY);
        }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (newBoundingRect) {
        ...
        mousedown$
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (edges) {
        ...
        mouseup$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function () {
            if (currentResize) {
    ...
    ResizableDirective.propDecorators = {
        validateResize: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        resizeEdges: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        enableGhostResize: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        resizeSnapGrid: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        resizeCursors: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        resizeCursorPrecision: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        ghostElementPositioning: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        allowNegativeResizes: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        mouseMoveThrottleMS: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        resizeStart: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"] }],
        resizing: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"] }],
        resizeEnd: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"] }]
    };
    return ResizableDirective;
}());
var PointerEventListeners = /** @class */ (function () {
    function PointerEventListeners(renderer, zone) {
        this.pointerDown = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            /** @type {?} */
        ...
        this.pointerMove = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            /** @type {?} */
        ...
        this.pointerUp = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            /** @type {?} */
...
var ResizeHandleDirective = /** @class */ (function () {
    ...
    function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            if (IS_TOUCH_DEVICE) {
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(_this.listenOnTheHost('touchend'), _this.listenOnTheHost('touchcancel')).subscribe(function (event) {
     ...
     */
    function (eventName) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this.element.nativeElement, eventName).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$));
    };
    ...
    ResizeHandleDirective.ctorParameters = function () { return [
        ...
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ElementRef"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgZone"] },
        { type: ResizableDirective, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Optional"] }] }
    ]; };
    ResizeHandleDirective.propDecorators = {
        resizeEdges: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
        resizableContainer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }]
    };
