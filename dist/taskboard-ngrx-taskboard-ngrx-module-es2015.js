...
const initialState = {
    todo: [
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Responsive', 'Etiam porta sem malesuada magna mollis euismod.', 'May 17', 'Elizabeth Elliott', 'assets/img/portrait/small/avatar-s-3.jpg', 'New'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('QA Testing', 'Etiam porta sem malesuada magna mollis euismod.', 'May 17', 'Elizabeth Elliott', 'assets/img/portrait/small/avatar-s-3.jpg', 'New'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Budget', 'Etiam porta sem malesuada magna mollis euismod.', 'May 17', 'Elizabeth Elliott', 'assets/img/portrait/small/avatar-s-3.jpg', 'New')
    ],
    inProcess: [
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('checklist', 'Etiam porta sem malesuada magna mollis euismod.', 'Apr 11', 'Bruce Reid', 'assets/img/portrait/small/avatar-s-1.jpg', 'In Process'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Navigation', 'Etiam porta sem malesuada magna mollis euismod.', 'Apr 11', 'Bruce Reid', 'assets/img/portrait/small/avatar-s-1.jpg', 'In Process'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Bootstrap 4', 'Etiam porta sem malesuada magna mollis euismod.', 'Apr 11', 'Bruce Reid', 'assets/img/portrait/small/avatar-s-1.jpg', 'In Process')
    ],
    backLog: [
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Assessment', 'Etiam porta sem malesuada magna mollis euismod.', 'Jun 19', 'Kelly Reyes', 'assets/img/portrait/small/avatar-s-5.jpg', 'Pending'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Schedule', 'Etiam porta sem malesuada magna mollis euismod.', 'Jun 19', 'Kelly Reyes', 'assets/img/portrait/small/avatar-s-5.jpg', 'Pending'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Unit tests', 'Etiam porta sem malesuada magna mollis euismod.', 'Jun 19', 'Kelly Reyes', 'assets/img/portrait/small/avatar-s-5.jpg', 'Pending')
    ],
    completed: [
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Angular 5', 'Etiam porta sem malesuada magna mollis euismod.', 'Aug 22', 'Sara Ali', 'assets/img/portrait/small/avatar-s-7.jpg', 'Completed'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Fields', 'Etiam porta sem malesuada magna mollis euismod.', 'Aug 22', 'Sara Ali', 'assets/img/portrait/small/avatar-s-7.jpg', 'Completed'),
        new _taskboard_ngrx_model__WEBPACK_IMPORTED_MODULE_0__["Task"]('Task board', 'Etiam porta sem malesuada magna mollis euismod.', 'Aug 22', 'Sara Ali', 'assets/img/portrait/small/avatar-s-7.jpg', 'Completed')
    ]
};
...
let TaskboardNGRXRoutingModule = class TaskboardNGRXRoutingModule {
};
...
let TaskboardNGRXComponent = class TaskboardNGRXComponent {
    ...
    ngOnInit() {
        ...
        this.subscription = this.taskboardState.subscribe(data => {
            this.todo = data.todo;
...
TaskboardNGRXComponent.ctorParameters = () => [
...
class Task {
    constructor(taskTitle, taskMessage, createdOn, createdBy, assignedTo, status) {
...
let TaskboardNGRXModule = class TaskboardNGRXModule {
};
...
//# sourceMappingURL=taskboard-ngrx-taskboard-ngrx-module-es2015.js.map