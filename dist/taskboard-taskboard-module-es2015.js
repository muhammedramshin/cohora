...
let TaskboardRoutingModule = class TaskboardRoutingModule {
};
...
let TaskboardComponent = class TaskboardComponent {
    constructor(elRef, taskBoardService) {
        this.elRef = elRef;
...
let TaskboardModule = class TaskboardModule {
};
...
let TaskBoardService = class TaskBoardService {
    constructor() {
        this.todo = [
...
//# sourceMappingURL=taskboard-taskboard-module-es2015.js.map