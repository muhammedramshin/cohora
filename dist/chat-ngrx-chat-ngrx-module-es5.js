...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.chatState.subscribe(function (data) {
            ...
            _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-8.jpg";
        });
    };
    ...
    ChatComponent.prototype.SetActive = function (event, chatId) {
        ...
        if (chatId === 'chat1') {
            this.subscription = this.store.select('chat').subscribe(function (data) {
                _this.chat = data.chat1;
                _this.activeChatUser = "Elizabeth Elliott";
                _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-3.jpg";
            });
        }
            ...
            this.subscription = this.store.select('chat').subscribe(function (data) {
                ...
                _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-7.jpg";
            });
        }
            ...
            this.subscription = this.store.select('chat').subscribe(function (data) {
                ...
                _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-5.jpg";
            });
        }
            ...
            this.subscription = this.store.select('chat').subscribe(function (data) {
                ...
                _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-9.jpg";
            });
        }
            ...
            this.subscription = this.store.select('chat').subscribe(function (data) {
                ...
                _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-4.jpg";
            });
        }
            ...
            this.subscription = this.store.select('chat').subscribe(function (data) {
                ...
                _this.activeChatUserImg = "assets/img/portrait/small/avatar-s-14.jpg";
            });
        }
    };
...
var initialState = {
    chat1: [
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'How can we help? We are here for you!'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-8.jpg', '1 hour ago', [
            'Hey John, I am looking for the best admin template.',
            'Could you please help me to find it out?',
            'It should be angular 5 bootstrap compatible.'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '30 minutes ago', [
            'Absolutely!',
            'Convex admin template is responsive Angular 6+ bootstrap admin template.'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-8.jpg', '20 minutes ago', [
            'Can you provide me audio link?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'http://static.videogular.com/assets/audios/videogular.mp3'
        ], 'audio'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-8.jpg', '10 minutes ago', [
            'Can you provide me video link?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'http://static.videogular.com/assets/videos/videogular.mp4'
        ], 'video'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-8.jpg', 'just now', [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-8.jpg', '', [
    ...
    chat2: [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-7.jpg', '1 hours ago', [
            'Hi, I spoke with a representative yesterday.',
            'he gave me some steps to fix my problem',
            'but they didn’t help.'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '20 minutes ago', [
            'Can you provide me audio link of your conversation?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-7.jpg', '', [
            'http://static.videogular.com/assets/audios/videogular.mp3'
        ], 'audio'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '10 minutes ago', [
    ...
    chat3: [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-8.jpg', '1 hours ago', [
            'Hey John, I am looking for the best admin template.',
            'Could you please help me to find it out?',
            'It should be angular 5 bootstrap compatible.'
        ], 'text'),
    ...
    chat4: [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-5.jpg', '1 hours ago', [
            'Hi, I spoke with a representative yesterday.',
            'he gave me some steps to fix my problem',
            'but they didn’t help.'
        ], 'text'),
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-5.jpg', '', [
            'http://static.videogular.com/assets/audios/videogular.mp3'
        ], 'audio'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '10 minutes ago', [
            'Can you provide me video link of your issue?'
    ...
    chat5: [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-9.jpg', '1 hours ago', [
            'Hey John, I am looking for the best admin template.',
            'Could you please help me to find it out?',
            'It should be angular 5 bootstrap compatible.'
        ], 'text'),
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-9.jpg', '20 minutes ago', [
            'Can you provide me audio link?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'http://static.videogular.com/assets/audios/videogular.mp3'
        ], 'audio'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-9.jpg', '10 minutes ago', [
            'Can you provide me video link?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'http://static.videogular.com/assets/videos/videogular.mp4'
        ], 'video'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-9.jpg', '', [
            'Looks clean and fresh UI.',
            'It is perfect for my next project.',
            'How can I purchase it?'
        ], 'text'),
    ...
    chat6: [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-4.jpg', '1 hours ago', [
            'Hi, I spoke with a representative yesterday.',
            'he gave me some steps to fix my problem',
            'but they didn’t help.'
        ], 'text'),
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-4.jpg', '', [
            'http://static.videogular.com/assets/audios/videogular.mp3'
        ], 'audio'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '10 minutes ago', [
            'Can you provide me video link of your issue?'
    ...
    chat7: [
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-14.jpg', '1 hours ago', [
            'Hey John, I am looking for the best admin template.',
            'Could you please help me to find it out?',
        ...
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-14.jpg', '20 minutes ago', [
            'Can you provide me audio link?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'http://static.videogular.com/assets/audios/videogular.mp3'
        ], 'audio'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-14.jpg', '10 minutes ago', [
            'Can you provide me video link?'
        ], 'text'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('right', 'chat', 'assets/img/portrait/small/avatar-s-1.jpg', '', [
            'http://static.videogular.com/assets/videos/videogular.mp4'
        ], 'video'),
        new _chat_ngrx_model__WEBPACK_IMPORTED_MODULE_1__["Chat"]('left', 'chat chat-left', 'assets/img/portrait/small/avatar-s-14.jpg', '', [
            'Looks clean and fresh UI.',
            'It is perfect for my next project.',
            'How can I purchase it?'
        ], 'text'),
...
function chatReducer(state, action) {
    ...
    switch (action.type) {
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT1"]):
            var chat1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat1);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat1: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat1, [action.payload]) });
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT2"]):
            var chat2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat2);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat2: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat2, [action.payload]) });
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT3"]):
            var chat3 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat3);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat3: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat3, [action.payload]) });
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT4"]):
            var chat4 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat4);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat4: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat4, [action.payload]) });
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT5"]):
            var chat5 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat5);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat5: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat5, [action.payload]) });
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT6"]):
            var chat6 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat6);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat6: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat6, [action.payload]) });
        case (_chat_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_CHAT7"]):
            var chat7 = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat7);
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { chat7: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.chat7, [action.payload]) });
        default:
            return state;
    }
}
...
//# sourceMappingURL=chat-ngrx-chat-ngrx-module-es5.js.map