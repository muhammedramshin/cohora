...
const routedComponents = [_calendar_component__WEBPACK_IMPORTED_MODULE_3__["CalendarsComponent"]];
...
let CalendarsComponent = class CalendarsComponent {
    constructor(modal) {
        this.modal = modal;
        this.view = 'month';
...
CalendarsComponent.ctorParameters = () => [
...
const DATE_TIME_PICKER_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => DateTimePickerComponent),
    multi: true
};
let DateTimePickerComponent = class DateTimePickerComponent {
    ...
    updateDate() {
        const newDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["setYear"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["setMonth"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["setDate"])(this.date, this.dateStruct.day), this.dateStruct.month - 1), this.dateStruct.year);
        this.onChangeCallback(newDate);
    }
    updateTime() {
        const newDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["setHours"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["setMinutes"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["setSeconds"])(this.date, this.timeStruct.second), this.timeStruct.minute), this.timeStruct.hour);
        this.onChangeCallback(newDate);
    }
};
