...
const data = __webpack_require__(/*! ../../shared/data/company.json */ "./src/app/shared/data/company.json");
let DTBasicComponent = class DTBasicComponent {
    constructor() {
        this.rows = [];
...
const data = __webpack_require__(/*! ../../shared/data/company.json */ "./src/app/shared/data/company.json");
let DTEditingComponent = class DTEditingComponent {
    constructor() {
        this.editing = {};
        this.rows = [];
        this.rows = data;
...
const data = __webpack_require__(/*! ../../shared/data/company.json */ "./src/app/shared/data/company.json");
let DTFilterComponent = class DTFilterComponent {
    constructor() {
        this.rows = [];
        this.temp = [];
        // Table Column Titles
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_swimlane_ngx_datatable_release__WEBPACK_IMPORTED_MODULE_2__["DatatableComponent"], { static: true }),
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2RhdGEtdGFibGVzL2Z1bGxzY3JlZW4vZHQtZnVsbHNjcmVlbi5jb21wb25lbnQuc2NzcyJ9 */"
...
const data = __webpack_require__(/*! ../../shared/data/employee.json */ "./src/app/shared/data/employee.json");
let DTFullScreenComponent = class DTFullScreenComponent {
    constructor() {
        this.rows = [];
        this.rows = data;
    }
...
const data = __webpack_require__(/*! ../../shared/data/company.json */ "./src/app/shared/data/company.json");
let DTPagingComponent = class DTPagingComponent {
    constructor() {
        this.rows = [];
        this.rows = data;
    }
...
const data = __webpack_require__(/*! ../../shared/data/employee.json */ "./src/app/shared/data/employee.json");
let DTPinningComponent = class DTPinningComponent {
    constructor() {
        this.rows = [];
        this.rows = data;
    }
...
const data = __webpack_require__(/*! ../../shared/data/company.json */ "./src/app/shared/data/company.json");
let DTSelectionComponent = class DTSelectionComponent {
    constructor() {
        this.rows = [];
        this.selected = [];
        this.columns = [
...
const data = __webpack_require__(/*! ../../shared/data/company.json */ "./src/app/shared/data/company.json");
let DTSortingComponent = class DTSortingComponent {
    constructor() {
        this.rows = [];
        this.columns = [
            { name: 'Company' },
