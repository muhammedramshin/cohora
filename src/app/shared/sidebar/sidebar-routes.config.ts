...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Home', icon: 'icon-home', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: '/dashboard/home', title: 'Home', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/dashboard/dashboard', title: 'Overview', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
    {
        path: 'cohora', title: 'Cohora Iq', icon: 'fa fa-superpowers', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: '/traffic', title: 'Traffics Heatmap/Live', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/action', title: 'Action Dashboard', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/visit', title: 'Visit Details', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/sentiment', title: 'Sentiment(emojis stats)', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/thoughput', title: 'ThoughtSpot', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
    {
        path: 'community', title: 'Community', icon: 'fa fa-users', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: '/homefeed', title: 'Home Feed', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Curation Library', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Chatroom', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Quiz', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Survey', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Poll', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Contest', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Notification message', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
    {
        path: 'customer', title: 'Customer View', icon: 'fa fa-user-circle', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: 'community', title: 'Customer Overview', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Guest Overview', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Import Customer', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Customer Tags', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Export Customers', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Segmentation', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
    {
        path: 'campaigns', title: 'Campaigns ', icon: 'fa fa-bullhorn', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: 'community', title: 'Campaign setup', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'View Campaign', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },

        ]
    },
    {
        path: 'shopbuzz', title: 'ShopBuzz Ads', icon: 'fa fa-shopping-cart', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: 'community', title: 'Product Tags Setup', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Product Tags Library', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Product Ads Setup', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: 'Product Ads Widget', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    {
        path: 'settings', title: 'Setting', icon: 'fa fa-cog', class: 'has-sub', badge: '', badgeClass: 'badge badge-pill badge-danger mt-1', isExternalLink: false, submenu: [
            { path: 'community', title: 'Company', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/community', title: '3rd Integration', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
